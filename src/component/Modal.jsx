    ...
    return (
        ...
        {!isSuccess && !isFailed && (
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input type="text" id="name" name="name" required className="w-full mb-2 p-2 border text-black" placeholder="Enter your name"/>
  
            <label className="font-semibold text-white" htmlFor="email">Email</label>
            <input type="email" id="email" name="email" required className="w-full mb-2 p-2 border text-black" placeholder="Enter a valid email Address" />
  
            <label className="font-semibold text-white" htmlFor="message">Message</label>
            <textarea id="message" name="message" rows="4" required className="w-full mb-4 p-2 border text-black" placeholder="Enter your message"/>
  
            <button type="submit" className="bg-[#333] text-white p-4 m-2 rounded-xl font-bold">
              Send Message
            </button>
          </form>
        </>
